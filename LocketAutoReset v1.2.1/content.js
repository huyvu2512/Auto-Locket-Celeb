...
class LocketCelebHelper {
    constructor() {
        ...
        this.CONNECTION_LOST_THRESHOLD = 5;
        this.TARGET_ERROR_MESSAGE = 'The connection was suddenly lost. Reconnecting after 5 second...';
    ...
    startLogObserver() {
        ...
        this.logObserver.observe(logContainer, { childList: true });
